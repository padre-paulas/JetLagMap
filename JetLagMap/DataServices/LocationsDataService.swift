...
class LocationsDataService {
    ...
    static let locations: [Location] = [
        ...
        Location(
            name: "Odawara Castle",
            cityName: "Odawara",
            coordinates: CLLocationCoordinate2D(latitude: 35.25083, longitude: 139.15361),
            description: "Odawara Castle is a reconstructed Japanese castle in the city of Odawara in Kanagawa Prefecture, Japan. The current donjon (keep) was constructed out of reinforced concrete in 1960 on a stone foundation of the former donjon, torn down from 1870–1872 during the Meiji Period. There has been fortifications at or around the castle's current site since the Kamakura Period (1185–1333).",
            imageNames: [
                "odawara-odawaracastle-1",
                "odawara-odawaracastle-2",
